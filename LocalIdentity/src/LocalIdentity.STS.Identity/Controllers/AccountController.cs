...
using LocalIdentity.STS.Identity.Configuration;
using LocalIdentity.STS.Identity.Helpers;
using LocalIdentity.STS.Identity.Helpers.Localization;
using LocalIdentity.STS.Identity.ViewModels.Account;
...
namespace LocalIdentity.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null, bool IsCalledFromRegisterWithoutUsername = false)
        {
            ...
            var setClaims = await _userManager.AddClaimsAsync(user, claims);
