...
using LocalIdentity.STS.Identity.Configuration.ApplicationParts;
using LocalIdentity.STS.Identity.Configuration.Constants;
...
namespace LocalIdentity.STS.Identity.Helpers
{
